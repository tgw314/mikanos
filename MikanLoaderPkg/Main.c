...
EFI_STATUS OpenBlockIoProtocolForLoadedImage(EFI_HANDLE image_handle,
    ...
    return gBS->OpenProtocol(loaded_image->DeviceHandle,
...
EFI_STATUS ReadBlocks(EFI_BLOCK_IO_PROTOCOL *block_io, UINT32 media_id,
    ...
    return block_io->ReadBlocks(block_io, media_id, 0 /* start LBA */,
                                read_bytes, *buffer);
}
...
EFI_STATUS EFIAPI UefiMain(EFI_HANDLE image_handle,
    ...
    struct MemoryMap memmap = {.buffer_size = sizeof(memmap_buffer),
                               .buffer = memmap_buffer,
                               .map_size = 0,
                               .map_key = 0,
                               .descriptor_size = 0,
