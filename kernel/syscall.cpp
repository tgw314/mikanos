    ...
    while (i < len) {
        ...
        switch (msg->type) {
            ...
            case Message::kMouseMove:
                app_events[i++] = {
                    .type = AppEvent::kMouseMove,
                    .arg.mouse_move = {.x = msg->arg.mouse_move.x,
            ...
            case Message::kMouseButton:
                app_events[i++] = {
                    .type = AppEvent::kMouseButton,
                    .arg.mouse_button = {.x = msg->arg.mouse_button.x,
                                         .y = msg->arg.mouse_button.y,
                                         .press = msg->arg.mouse_button.press,
                                         .button =
            ...
            case Message::kTimerTimeout:
                if (msg->arg.timer.value < 0) {
                    app_events[i++] = {
                        .type = AppEvent::kTimerTimeout,
                        .arg.timer = {.timeout = msg->arg.timer.timeout,
                                      .value = -msg->arg.timer.value},
                    };
                }
                break;
            default:
...
SYSCALL(OpenFile) {
    ...
    if (dir->attr != fat::Attribute::kDirectory && post_slash) {
        return {0, ENOENT};
    }
